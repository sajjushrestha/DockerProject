...
###################################Go to the path and run below commands where docker-compose.yaml is saved##########################
docker-compose up  -- To run docker-compose.yaml  file
docker-compose scale chrome=2  -- To increase chrome nodes in grid
docker-compose down  -- To stop grid and to cleanup the created containers
